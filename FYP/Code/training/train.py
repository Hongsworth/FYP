...
def test_training(args, h, net_for_testtraining, Noise, PATH_before_adapt, PATH_after_adapt, adapt_steps, noise_var): #PATH_before_adapt can be meta-learneds
    ...
    for epochs in range(num_adapt):
        ...
        if args.if_attention:
            out = net_for_testtraining(m, h, Noise, args.device, args.if_RTN, args.if_true_snr, noise_var)
        else:
            out = net_for_testtraining(m, h, Noise, args.device, args.if_RTN, args.if_true_snr, noise_var)
