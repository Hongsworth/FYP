...
def test_per_channel_per_snr(args, h, net_for_testtraining, test_snr, actual_channel_num, PATH_after_adapt, if_val, noise_var):
    ...
    if args.if_attention:
        out_test = net_for_testtraining(m_test, h, Noise_test, args.device, args.if_RTN, args.if_true_snr, noise_var)
    else:
        out_test = net_for_testtraining(m_test, h, Noise_test, args.device, args.if_RTN, args.if_true_snr, noise_var)
